...
const loadOtherProfile = () => {
  ...
  fetch(`https://net-book.vercel.app/accounts/friend/${user_id}/${accountId}/`)
    .then((res) => res.json())
    .then((data) => {
      // console.log(data)
      if (data.receiver_account == null) {
        // friend na
        fetch(
          `https://net-book.vercel.app/accounts/send/request/${user_id}/${accountId}/`
        )
          .then((res) => res.json())
          .then((data) => {
            ...
            if (data.receiver == null) {
              fetch(
                `https://net-book.vercel.app/accounts/send/request/${accountId}/${user_id}/`
              )
                .then((res) => res.json())
                .then((data) => {
                  if (data.sender == accountId) {
                    ...
                    fetch(
                      `https://net-book.vercel.app/accounts/profile/${accountId}/`
                    )
                      .then((res) => res.json())
                      .then((account) => {
                        ...
                        fetch(
                          `https://net-book.vercel.app/accounts/user/${account.user}/`
                        )
                          .then((res) => res.json())
                          .then((user) => {
...
const addFriend = (event, id) => {
  ...
  fetch(`https://net-book.vercel.app/accounts/profile/${id}/`)
    .then((res) => res.json())
    .then((data) => {
      const receiver = {
      ...
      fetch(`https://net-book.vercel.app/accounts/friend/request/`, {
        method: "POST",
        headers: {
...
const removeRequest = (event, id, track) => {
  ...
  if (track == 1) {
    // console.log(track)
    fetch(`https://net-book.vercel.app/accounts/accept/${accountId}/${id}/${0}/`, {
      method: "GET",
      headers: {
        "content-type": "application/json",
        Authorization: `Token ${token}`,
    ...
    fetch(`https://net-book.vercel.app/accounts/accept/${id}/${accountId}/${0}/`, {
      method: "GET",
      headers: {
        "content-type": "application/json",
        Authorization: `Token ${token}`,
...
const Confirm = (event, id) => {
  ...
  fetch(`https://net-book.vercel.app/accounts/accept/${id}/${accountId}/${1}/`, {
    method: "GET",
    headers: {
      "content-type": "application/json",
      Authorization: `Token ${token}`,
