...
.then(data =>{
    ...
    if (token){
        ...
        parent.innerHTML = `<a class="navbar-brand" id="navbar-brand" href="./home.html" style="color:#06537A;"><b>Net Book</b></a>`
        navLeftSideElement.innerHTML += `
                            <li class="nav-item mx-4">
                                <a class="nav-link active" aria-current="page" href="./home.html"><i class="fa-solid fa-house fs-4" style="color:#06537A;"></i></a>
                            </li>
                            <li class="nav-item mx-4">
                                <a class="nav-link addPost home"  data-bs-toggle="modal" data-bs-target="#createPostModal"><i class="fa-solid fa-square-plus fs-4" style="color:#06537A;"></i></a>
                            </li>
                            <li class="nav-item mx-4">
                                <a class="nav-link" href="./friends.html"><i class="fa-solid fa-user-group fs-4" style="color:#06537A;"></i></a>
                            </li>
                            <li class="nav-item mx-4">
                                <a class="nav-link" href="./request.html"><i class="fa-solid fa-user-plus fs-4" style="color:#06537A;"></i></a>
                            </li>
